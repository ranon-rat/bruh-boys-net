...
// text animation
const howMany = 10//how many random phrases
...
// background animation
  const howManyImages = 29// this is for knowing the random images
  let change = false;
...
// this is for keeping something constant
  ...
  ctx.fillText("👁 Tecnopsychosis 👁", canvas.width / 2, canvas.height / 2)
}
setInterval(async () => {
